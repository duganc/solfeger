...
var $author$project$PageTests$mouseDown = function (query) {
...
var $author$project$PageTests$mouseUp = function (query) {
...
var $author$project$PageTests$simulateSubscriptions = function (_v0) {
	return $avh4$elm_program_test$SimulatedEffect$Sub$batch(
		A2(
			...
			_List_fromArray(
				[
					A3($avh4$elm_program_test$SimulatedEffect$Ports$subscribe, 'keydown', $author$project$KeyboardKey$keyDecoder, $author$project$Page$KeyDownOn),
					A3($avh4$elm_program_test$SimulatedEffect$Ports$subscribe, 'keyup', $author$project$KeyboardKey$keyDecoder, $author$project$Page$KeyUpOn)
				])));
};
					...
					case 'CharacterKey':
						...
						if (_v4.$ === 'Ok') {
							...
							return _Utils_Tuple2(
								...
								$author$project$Page$playTone(
									$author$project$Note$toString(
										A2($author$project$Page$adjustOctave, model.octaveAdjustment, note))));
						} else {
							var s = _v4.a;
							return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
						}
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($author$project$Page$activeKeyInScale, model.selectedScale, n),
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					A3($author$project$Page$getLabelFromKey, model.selectedScale, model.isKeyPressed, n))
				]));
	});
...
var $author$project$Page$view = function (model) {
	return _List_fromArray(
		[
			...
			$author$project$Page$renderScaleSelector(model.selectedScale)),
...
var $author$project$PageTests$startProgramForTesting = F2(
	function (initialUrl, flags) {
		return A2(
			...
			A2(
				...
				$author$project$PageTests$simulateSubscriptions,
				A2(
...
var $author$project$PageTests$testKeyClickDisplaysSolfege = A2(
	$elm_explorations$test$Test$test,
	...
	function (_v0) {
		return A2(
			...
			A2(
				$author$project$PageTests$mouseUp,
				...
				A2(
					...
					A2(
						$author$project$PageTests$mouseDown,
						$elm_explorations$test$Test$Html$Query$find(
							_List_fromArray(
								[
									$elm_explorations$test$Test$Html$Selector$id('key-10')
										...
										A2(
											...
											A2(
												...
												A2(
													...
													A2($author$project$PageTests$startProgramForTesting, 'http://www.mysolfegeapp.com', _Utils_Tuple0))))))))))));
	});
...
var $author$project$PageTests$testKeyRenders = A2(
	$elm_explorations$test$Test$test,
	'keyRenders',
	function (_v0) {
		return A2(
			...
			$elm_explorations$test$Test$Html$Query$fromHtml(
				A2(
					$author$project$Page$renderKey,
					A3($author$project$Page$Model, $elm$core$Dict$empty, 0, $author$project$Scale$default),
					57)));
	});
...
var $author$project$PageTests$keyboardKeyObject = function (key) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$PageTests$testKeyboardKeyPressDisplaysSolfege = A2(
	$elm_explorations$test$Test$test,
	...
	function (_v0) {
		return A2(
			...
			A3(
				...
				'keyup',
				$author$project$PageTests$keyboardKeyObject(
...
var $author$project$PageTests$getIdSelector = F2(
	function (s, i) {
		return $elm_explorations$test$Test$Html$Selector$id(
			s + ('-' + $elm$core$String$fromInt(i)));
	});
var $author$project$PageTests$getScaleNoteSelector = $author$project$PageTests$getIdSelector('scale-note');
var $author$project$PageTests$testPageHasScaleNoteSelector = A2(
	$elm_explorations$test$Test$test,
	...
	function (_v0) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				$author$project$PageTests$getScaleNoteSelector,
				A2($elm$core$List$range, 0, 11)),
			A2($author$project$PageTests$startProgramForTesting, 'http://www.mysolfegeapp.com', _Utils_Tuple0));
	});
var $author$project$PageTests$getScaleTypeSelector = $author$project$PageTests$getIdSelector('scale-type');
var $author$project$PageTests$testPageHasScaleTypeSelector = A2(
	$elm_explorations$test$Test$test,
	...
	function (_v0) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				$author$project$PageTests$getScaleTypeSelector,
				A2($elm$core$List$range, 0, 6)),
			A2($author$project$PageTests$startProgramForTesting, 'http://www.mysolfegeapp.com', _Utils_Tuple0));
	});
var $author$project$PageTests$getKeySelector = $author$project$PageTests$getIdSelector('key');
var $author$project$PageTests$testPageHasTwelveKeys = A2(
	$elm_explorations$test$Test$test,
	'pageHasTwelveKeys',
	function (_v0) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				$author$project$PageTests$getKeySelector,
				A2($elm$core$List$range, 0, 11)),
			A2($author$project$PageTests$startProgramForTesting, 'http://www.mysolfegeapp.com', _Utils_Tuple0));
	});
var $author$project$PageTests$stubPageModel = A3(
	...
	_Utils_Tuple0);
var $author$project$PageTests$testPressKeyOnModel = A2(
	$elm_explorations$test$Test$test,
	'pressesKeyOnModel',
	function (_v0) {
		return A2(
			...
			A2(
				...
				A2(
					$author$project$Page$pressKeyOnModel,
					$author$project$PageTests$stubPageModel.a,
...
var $author$project$PageTests$testRenderKeysRendersTheCorrectNumberOfKeys = A2(
	$elm_explorations$test$Test$test,
	...
	function (_v0) {
		return A2(
			...
			A2(
				...
				$elm_explorations$test$Test$Html$Query$fromHtml(
					A2(
						$author$project$Page$renderKeys,
						A3($author$project$Page$Model, $elm$core$Dict$empty, 0, $author$project$Scale$default),
						3))));
	});
...
var $author$project$PageTests$testShowTextShowsAlternateTextWhenFalse = A2(
	$elm_explorations$test$Test$test,
	...
	function (_v0) {
		return A2(
			$elm_explorations$test$Expect$equal,
			'Alternative text',
			A3($author$project$Page$showText, 'Here\'s some text', 'Alternative text', false));
	});
var $author$project$PageTests$testShowTextShowsTextWhenTrue = A2(
	$elm_explorations$test$Test$test,
	...
	function (_v0) {
		return A2(
			$elm_explorations$test$Expect$equal,
			'Here\'s some text',
			A3($author$project$Page$showText, 'Here\'s some text', 'Alternative text', true));
	});
	...
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'PageTests',
				_List_fromArray(
					[$author$project$PageTests$testShowTextShowsAlternateTextWhenFalse, $author$project$PageTests$testKeyClickDisplaysSolfege, $author$project$PageTests$testPageHasScaleNoteSelector, $author$project$PageTests$testPageHasTwelveKeys, $author$project$PageTests$testRenderKeysRendersTheCorrectNumberOfKeys, $author$project$PageTests$testKeyboardKeyPressDisplaysSolfege, $author$project$PageTests$testShowTextShowsTextWhenTrue, $author$project$PageTests$testPageHasScaleTypeSelector, $author$project$PageTests$testKeyRenders, $author$project$PageTests$testPressKeyOnModel])),
				A2(
				$elm_explorations$test$Test$describe,
				'SolfegeTests',
				_List_fromArray(
				...
				'ScaleTests',
				_List_fromArray(
					[$author$project$ScaleTests$testGetsSolfegeFromNoteAndScale, $author$project$ScaleTests$testGetsAbsoluteStringFromHighDo, $author$project$ScaleTests$testGetsAbsoluteStringReturnsErrorForNonKey, $author$project$ScaleTests$testScaleGetsCorrectNotes, $author$project$ScaleTests$testGetsSolfegeAgreesWithFromInt, $author$project$ScaleTests$testGetsAbsoluteStringFromValidKeyboardKey, $author$project$ScaleTests$testKeyClickHandlesHighDo])),
				A2(
				$elm_explorations$test$Test$describe,
				'NoteTests',
				_List_fromArray(
